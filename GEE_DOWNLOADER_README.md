...
- **Multiple Dataset Support**: ERA5, ASTER, Landsat 8/9 (L1 and L2)
...
- **Output**: `downloaded_era5_{task_id}.zip`
- **Files**: 
  - `skin_temperature_era5_{YYYYMMDD}_100000Z.tif`
  - `temperature_2m_era5_{YYYYMMDD}_100000Z.tif`

### ASTER Global Emissivity Dataset
- **Source**: `NASA/ASTER_GED/AG100_003`
- **Bands**: `emissivity_band10`, `emissivity_band11`, `emissivity_band12`, `emissivity_band13`, `ndvi`
- **Output**: `downloaded_aster_{task_id}.zip`
- **Files**:
...
- **Files**:
  - `L8_L1_B10_{YYYYMMDD}_00.tif` (Thermal Infrared Band 10)
  - `L8_L1_B11_{YYYYMMDD}_00.tif` (Thermal Infrared Band 11)
...
- **Files**:
  - `L8_L2_SR_B1_{YYYYMMDD}_00.tif` through `L8_L2_SR_B7_{YYYYMMDD}_00.tif`
  - `L8_L2_QA_PIXEL_{YYYYMMDD}_00.tif`
...
**Available datasets**: `era5`, `aster`, `landsat8_l1`, `landsat8_l2`, `landsat9_l1`, `landsat9_l2`
...
output_directory/
├── downloaded_zips/
│   ├── downloaded_era5_{task_id}.zip
│   ├── downloaded_aster_{task_id}.zip
│   ├── landsat8_l1_{task_id}.zip
│   ├── landsat8_l2_{task_id}.zip
│   ├── landsat9_l1_{task_id}.zip
│   └── landsat9_l2_{task_id}.zip
└── task_mapping.json
```
